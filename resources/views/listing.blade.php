...
@section('content')
    ...
    <div class="mx-4">
        <div class="bg-gray-50 border border-gray-200 p-12 rounded">
            <div class="flex flex-col items-center justify-center text-center">
                ...
                <div>
                    ...
                    <div class="text-lg space-y-6">
                        ...
                        <a href="https://test.com" target="_blank" class="block bg-black text-white py-2 rounded-xl hover:opacity-80"><i class="fa-solid fa-globe"></i> Visit
                            Website</a>
                    </div>
                </div>
            </div>
